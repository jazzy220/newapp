            ...
            <div>
                ...
                <div className="card my-3">
                    ...
                    <div className="card-body" >
                        <h5 className="card-title">{!title ? "This Title is not defined Click read more to read" : title === "[Removed]" ? "This descrioption is not defined Click read more to read" : description}<span class="badge bg-secondary">New</span></h5>
